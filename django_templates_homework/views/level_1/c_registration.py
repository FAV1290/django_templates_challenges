...
Задания:
    1. Откройте страницу http://127.0.0.1:8000/registration/ и убедитесь,
       что нет ни заголовка, ни названия у вкладки в брузере.
    ...
    4. Откройте страницу http://127.0.0.1:8000/registration/ и убедитесь,
       что и заголовок, и название у вкладки появились.
"""
